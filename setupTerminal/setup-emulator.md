...
::: warning Note
If after selecting Language you get a crash in logcat (<span style="font-style: italic; color: #FF0000">java.lang.SecurityException: Not allowed to bind to service Intent { act=co.poynt.os.services.v1.IPoyntCapabilityManager }</span>), just rerun the python installer script.
:::
